...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/new-transaksi', 'App\Http\Controllers\transaksiController@newtransaksi');
    Route::post('/new-transaksi', 'App\Http\Controllers\transaksiController@newtransaksiprocess');
